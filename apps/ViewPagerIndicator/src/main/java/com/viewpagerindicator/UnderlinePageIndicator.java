...
public class UnderlinePageIndicator extends View
    ...
    private int mTitleScrollerCurrX = 0;
    private int mTitleScrollerCurrY = 0;
    ...
    private boolean mIsIndicatorOnly = false;
    private boolean mIsLineOnly = false;
    ...
    public UnderlinePageIndicator(Context context, AttributeSet attrs,
        ...
        Drawable tmp = a.getDrawable(R.styleable.UnderlinePageIndicator_selectedBitmap);

        if (tmp != null) {
            BitmapDrawable bd = (BitmapDrawable) tmp;
            mSelectedBitmap = bd.getBitmap();
        }
        if (background != null) {
    ...
    @Override
    public void onTabScrollerChange(int width, int height, int currX, int currY) {
        if (getWidth() > 0) {
            mTitleScrollerCurrX = currX * width / getWidth();
            mTitleScrollerCurrY = currY;
        }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        final float pageWidth = (getWidth() - mTitleScrollerCurrX - paddingLeft - getPaddingRight())
                / (1f * count);
        ...
        /** draw indicator */
        if (!mIsLineOnly) {
            canvas.drawBitmap(mSelectedBitmap,
                    (right + left - mSelectedBitmap.getWidth()) / 2, bottom
                            - mSelectedBitmap.getHeight(), mPaint);
        }
    }
...
//            throw new IllegalStateException("ViewPager has not been bound.");
    ...
    public void setIndicatorOnly(boolean flag) {
        this.mIsIndicatorOnly = flag;
    }

    public void setLineOnly(boolean flag) {
        this.mIsLineOnly = flag;
    }
