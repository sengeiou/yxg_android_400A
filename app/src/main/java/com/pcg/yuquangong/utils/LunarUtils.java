...
public class LunarUtils {
     ...
     * @return
     */
    public static String getSolarString(int year, int month, int monthDay)
    {
        String result = "";
        if(year>0)
        {
     ...
     * @return
     */
    public static String getLunarString(int year, int month, int monthDay)
    {
        String result = "";
        if(year>0)
        {
     ...
     */
    public static int[] getLunarMonths(int year)
    {
